...
/* *************************************************************************************************
        ...
        Created as part of the qbLinAlg linear algebra library, which is
...
public:
  ...
  template <class U>
  friend qbMatrix2<U> operator+(const qbMatrix2<U>& lhs,
                                const qbMatrix2<U>& rhs);
  template <class U>
  ...
  // qbMatrix2 * qbVector.
  template <class U>
  friend qbVector<U> operator*(const qbMatrix2<U>& lhs, const qbVector<U>& rhs);
...
template <class T>
bool qbMatrix2<T>::Separate(qbMatrix2<T>& matrix1, qbMatrix2<T>& matrix2,
                            int colNum)
{
